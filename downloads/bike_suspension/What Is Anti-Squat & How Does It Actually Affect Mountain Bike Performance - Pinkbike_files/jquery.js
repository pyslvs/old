            ...
            $('div.pp_overlay').show().fadeTo(settings.animationSpeed,settings.opacity, function(){
                $pp_pic_holder.fadeIn(settings.animationSpeed,function(){
                    ...
                    if(pp_type == 'image'){
                        ...
                        var videoid = grab_param('vid',images[setPosition]);
                        ...
                        if(pp_type == 'youtube'){
                            ...
                            pp_typeMarkup = '<iframe src ="'+movie_url+'?vid='+videoid+'" width="'+(correctSizes['width']-10)+'" height="'+(correctSizes['height']-10)+'" frameborder="no" SCROLLING=NO></iframe>';
                        }
